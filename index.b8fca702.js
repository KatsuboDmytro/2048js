...
function handleInput(event) {
    ...
    const newTile = new (0, _tileClass.Tile)(gridElement);
...
},{"../modules/Game.class":"eIbh2","../modules/Tile.class":"6mLPk"}],"eIbh2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Game", ()=>Game);
var _ceilClass = require("./Ceil.class");
...
class Game {
    constructor(gridElement){
        this.cells = [];
        for(let i = 0; i < CELLS_COUNT; i++)this.cells.push(new (0, _ceilClass.Ceil)(gridElement, i % GRID_SIZE, Math.floor(i / GRID_SIZE)));
        this.score = 0;
    ...
    start(gridElement) {
        this.getRandomEmptyCell().linkTile(new (0, _tileClass.Tile)(gridElement));
        this.getRandomEmptyCell().linkTile(new (0, _tileClass.Tile)(gridElement));
    }
    restart() {
...
},{"./Ceil.class":"4lDUC","./Tile.class":"6mLPk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4lDUC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"6mLPk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["l1XHo","3cYfC"], "3cYfC", "parcelRequire7b01")
